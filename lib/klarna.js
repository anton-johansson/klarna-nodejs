 ...
 */
Klarna.prototype.getAddresses = function(pno, callback)
{
	// Validations
	...
	// Create digest
	var digestSecret = digest([this.eid, pno, this.sharedSecret]);

	// Create list of parameters
	var parameters = [pno, this.eid, digestSecret, 2, 5, this.clientIP];
