 ...
 *
 * @param pno The social security or organization number to validate.
 */
validate.pno = function(pno)
{
    return validator.isLength(pno, 1);
};

/**
 * Validates the reservation number.
 *
 * @param rno The reservation number to validate.
 */
validate.rno = function(rno)
{
    return validator.isInt(rno, { min: 1 });
};
